                    ...
                    <div class="panel-body">
                        <div class="col-md-8">
                            ...
                            <form role="form" method="post">
                                <div class="form-group">
                                    <label>Họ & Tên</label>
                                    <input type="text" name="user_name" required class="form-control" value="<?= $data['user_name'] ?>" placeholder="">
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="email" name="user_mail" required value="<?= $data['user_mail'] ?>" class="form-control">
                                </div>
                                <div class="form-group">
